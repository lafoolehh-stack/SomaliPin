...
/*
-- UPDATED SQL & STORAGE SETUP FOR SOMALIPIN
-- 
-- IMPORTANT: To fix "Bucket not found" error:
-- 1. Go to your Supabase Dashboard -> Storage
-- 2. Click "New Bucket"
-- 3. Name it: profile-pictures
-- 4. Set it to "Public" (for easier access)
-- 5. Add a Policy: Allow "anon" or "authenticated" to INSERT and SELECT.
